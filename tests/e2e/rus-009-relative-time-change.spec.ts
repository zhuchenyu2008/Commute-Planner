...
const email = "rus-009@example.com";
const password = "password";
const initialPrompt = "2026-07-03 09:00 arrive at Longhu Tianjie";
const changePrompt = "move arrival 20 minutes earlier";
const expectedInitialArriveAt = new Date("2026-07-03T01:00:00.000Z");
const expectedChangedArriveAt = new Date("2026-07-03T00:40:00.000Z");
...
test("RUS-009 interprets a relative earlier-arrival change from current trip context", async ({
  page,
}) => {
