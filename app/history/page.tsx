    ...
    <AppShell active="history">
      <div className="mx-auto max-w-3xl space-y-5">
        <header>
          ...
          <h1 className="mt-1 text-3xl font-bold text-[#191c1e]">History</h1>
        </header>

        {trips.length === 0 ? (
          <GlassCard className="p-6">
            <p className="text-sm font-medium text-[#434655]">
              Planned trips will appear here after the agent creates them.
            </p>
          </GlassCard>
        ) : (
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="min-w-0">
                        ...
                        <p className="mt-1 flex items-center gap-1 text-sm text-[#434655]">
                          ...
                          {trip.finalStopName ?? "Destination pending"}
                        </p>
                      </div>
